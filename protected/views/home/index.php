		...
		<div class="row">
			<div class="col-md-20">
				<div class="top-contents">
					<div class="right-texts orange">
						<h3>HIDUP SEHAT MULAI
							DARI <i>BEST MEAT</i> !</h3>
					</div>
				</div>
			</div>
			<div class="col-md-40">
			...
			<div class="col-md-60 text-center">
				<div class="title-text orange mb-4">
			...
			<div class="col-md-20">
				<div class="box-contents p-2">
					<img src="<?php echo $this->assetBaseurl; ?>home/wcu3.png">
			...
			<div class="col-md-20">
				<div class="box-contents p-2">
					<img src="<?php echo $this->assetBaseurl; ?>home/wcu1.png">
					<div class="title my-2">
			...
			<div class="col-md-20">
				<div class="box-contents p-2">
					<img src="<?php echo $this->assetBaseurl; ?>home/wcu2.png">
					<div class="title my-2">
...
<section class="home-sec-3">
	<div class="prelative container">
		<div class="row">
			<div class="col-md-60 my-4">
				<div class="title-text text-center">
					<h3 class="my-2">BEST MEAT <span class="tipografi"> IDE RESEP MAKANAN</span></h3>
					<p>Untuk menunjang kebutuhan protein bagi keluarga di Indonesia, Best Meat selalu mengutamakan 3 poin penting pada setiap produknya. Hal tersebutlah yang menjadikan Best Meat sebagai produk terbaik di Indonesia.</p>
				</div>
			</div>
			<div class="col-md-20">
				<div class="box-contents">
					<img src="<?php echo $this->assetBaseurl; ?>home/resep-1.jpg">
					<div class="title p-4">
						<h5>Ayam Woku BestChicken</h5>
						<p>Makanan khas Manado ini bercita rasa pedas dan sarat akan penggunaan daun rempah, seperti daun kemangi, daun jeruk, daun kunyit, dan ...</p>
					</div>
				</div>
			</div>
			<div class="col-md-20">
